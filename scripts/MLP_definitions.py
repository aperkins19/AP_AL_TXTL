...
# Second layer is each layer in the MLP
    ...
    "4":{
        ...
        "layers":{
            ...
            2: {"Hidden Nodes": 100, "activation":"relu", "Dropout": 0.2},
            3: {"Hidden Nodes": 100, "activation":"relu", "Dropout": 0.2},
            4: {"Hidden Nodes": 100, "activation":"relu", "Dropout": 0.2},
            5: {"Hidden Nodes": 100, "activation":"relu", "Dropout": 0.2},
            6: {"Hidden Nodes": 32, "activation":"relu"},
            7: {"Output": True, "activation":"relu"}
        }
    },
    ...
    "6":{
       "HyperParams": {
        ...
        "layers":{
            ...
            5: {"Hidden Nodes": 100, "activation":"relu", "Dropout": 0.2},
            6: {"Hidden Nodes": 32, "activation":"relu"},
            7: {"Output": True, "activation":"linear"}
        }
    }
}